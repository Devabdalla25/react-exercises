        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              <span className="absolute top-0 right-0 h-3 w-3 rounded-full bg-red-400 ring-2 ring-white"></span>
              <button className="p-2 text-gray-400 hover:text-gray-500 text-2xl">
                  🔔
                </button>
            </div>
              <div className="bg-gradient-to-b from-purple-400 to-pink-500 rounded-full w-10 h-10 font-semibold justify-center items-center flex text-2xl">💲</div>
          </div>
        </div>
      </div>
